		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				if (isset($_POST['create_comment'])) {
					...
					$query = "UPDATE posts SET post_comment_counter = post_comment_counter + 1 WHERE post_id = $the_post_id";
				...
				<div class="well">
					...
					<form role="form" action="#" method="post">
						...
						<div class="form-group">
							...
							<input type="email" name="comment_email" id="comment_author" class="form-control">
						</div>
						<div class="form-group">
